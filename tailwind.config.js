  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        'spring-in-right': 'spring-in-right 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) forwards',
        'spring-in-left': 'spring-in-left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) forwards',
        'spring-in-up': 'spring-in-up 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) forwards',
        'spring-in-down': 'spring-in-down 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) forwards',
