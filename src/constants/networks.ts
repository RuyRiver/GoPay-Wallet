...
// Default network (get from env or default to mainnet)
const networkFromEnv = import.meta.env.VITE_STACKS_NETWORK || 'mainnet';
export const DEFAULT_NETWORK = NETWORKS[networkFromEnv] || NETWORKS.mainnet;
