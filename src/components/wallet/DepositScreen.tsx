...
interface DepositScreenProps {
  onClose: () => void;
  tokenSymbol?: string; // Optional: which token the user wants to deposit
}

const DepositScreen: React.FC<DepositScreenProps> = ({ onClose, tokenSymbol }) => {
  ...
  // Get display text based on token
  const getTokenDisplayText = () => {
    if (tokenSymbol) {
      return `Share your address to receive ${tokenSymbol} tokens`;
    }
    return "Share your address to receive STX, sBTC, or USDA tokens";
  };
    ...
    <div className="h-full flex flex-col overflow-hidden bg-white">
      ...
      <div className="p-4 flex items-center border-b border-gray-200 bg-white">
        ...
        <h2 className="text-lg font-semibold mx-auto">
          {tokenSymbol ? `Deposit ${tokenSymbol}` : "Deposit"}
        </h2>
      ...
      <div className="flex-1 overflow-y-auto p-5">
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm text-gray-500 mb-2">Scan this QR code to deposit tokens</p>
