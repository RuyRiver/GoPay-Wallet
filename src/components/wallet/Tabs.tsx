...
const Tabs: React.FC<TabsProps> = ({
  ...
  return <div className="self-stretch bg-[rgba(243,245,246,1)] flex items-center gap-[17px] text-sm font-semibold whitespace-nowrap text-center justify-center p-1 rounded-2xl">
