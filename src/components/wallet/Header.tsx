...
import ContactsCircles from "./ContactsCircles";
...
const Header: React.FC<HeaderProps> = ({
  ...
  return <div className="flex flex-col w-full self-stretch text-center relative pb-4">
      ...
      <div className="relative z-10 py-8 self-stretch flex flex-col justify-center items-center text-white tracking-[0.2px]">
